...
contract Ownable {
    ...
    event TransferredOwner(address indexed owner, address indexed newOwner);
    //  TODO's
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "This is an invalid address");
        emit TransferredOwner(_owner, newOwner);
        _owner = newOwner;
    }
}
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "'to' address must not be the owner");
    ...
    function _transferFrom(
        ...
        require(from == owner, "Address is not the token owner");
...
contract UdacityCapstoneERC721Mintable is ERC721Metadata {
    constructor(
        string memory name,
        string memory symbol,
        string memory baseTokenURI
